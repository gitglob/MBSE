...
class GUI:
    ...
    def __init__(self, master, canvas):
        ...
        self.canvas = canvas
        self.startButton_window = self.canvas.create_window(360, 645, window = self.startButton )
        self.parameters_window = self.canvas.create_window(510, 645, window = self.parameters_button )
        self.quitButton_window = self.canvas.create_window(605, 645, window = self.quitButton )
       
        self.days = 1
        self.sensors_distance = 30
        self.sensors_period = 1800
...
#%%     ##################### PARAMETERS #####################
    def set_parameters(self): 
        ...
        button1 = tk.Button(self.parameters, text = "Set the Days for the Simulation", command = self.set_days)
        ...
        button2 = tk.Button(self.parameters, text = "Set the Sensors Sampling Period in Secs", command = self.set_sensors_period)
